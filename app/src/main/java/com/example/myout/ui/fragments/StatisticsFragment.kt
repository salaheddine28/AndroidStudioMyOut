...
import com.example.myout.databinding.FragmentStatisticsBinding
import com.example.myout.other.CustomMarkerView
import com.example.myout.other.TrackingUtil
import com.example.myout.ui.viewmodels.StatisticsViewModel
...
class StatisticsFragment : Fragment(R.layout.fragment_statistics) {
    ...
    private fun subscribeToObservers() {
        ...
        viewModel.runsSortedByDate.observe(viewLifecycleOwner, Observer {
            it?.let {
                val allAverageSpeeds = it.indices.map { i -> BarEntry(i.toFloat(), it[i].averageSpeed) }
